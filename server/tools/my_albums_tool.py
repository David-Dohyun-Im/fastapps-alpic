...
class MyAlbumsTool(BaseWidget):
    identifier = "my_albums"
    title = "My Albums"
    description = "Photo albums gallery widget with fullscreen viewer"
    invoking = "Loading albums..."
    invoked = "Albums ready!"
    input_schema = MyAlbumsInput

    async def execute(self, input_data: MyAlbumsInput, context=None, user=None):
