...
class MyCarouselInput(BaseModel):
...
class MyCarouselTool(BaseWidget):
    ...
    async def execute(self, input_data: MyCarouselInput, context=None, user=None):
