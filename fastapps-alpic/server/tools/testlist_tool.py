...
class TestlistTool(BaseWidget):
    identifier = "testlist"
    title = "Testlist"
    description = "A ranked list widget"
    invoking = "Loading list..."
    invoked = "List ready!"
    input_schema = TestlistInput

    async def execute(self, input_data: TestlistInput, context=None, user=None):
